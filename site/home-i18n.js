(() => {
  ...
  const JA_COPY = Object.freeze({
    ...
    "I matched this to your investigation workflow. Autorun is tracing the cause and preserving the review evidence now.": "この仕事に、あなたの調査ワークフローを適用しました。Autorunが原因を追い、レビュー用の根拠を残します。",
    ...
    "I matched this to your decision-brief workflow. Autorun is applying your materiality and evidence checks now.": "この仕事に、あなたの意思決定資料ワークフローを適用しました。Autorunが重要性と根拠の確認を進めます。",
