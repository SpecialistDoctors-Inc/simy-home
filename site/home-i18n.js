(() => {
  ...
  const JA_COPY = Object.freeze({
    ...
    "Industry-ready · SIMY Quality": "業種別に最適化 · SIMY Quality",
    "Swipe to compare plans →": "横にスワイプしてプランを比較 →",
    "Quality checks shaped around your profession.": "あなたの業種に合った品質チェックを。",
    "Choose IT Engineer, Financial Planner, Pharmaceutical MR, or Dental Clinic. The same SIMY Quality (SQM) adapts its terminology, workflow, and review criteria to your field.": "SIMY Quality（SQM）は、ITエンジニア・ファイナンシャルプランナー・製薬MR・歯科クリニック向けとして選べます。既存のQuality（SQM）が、業種ごとの用語、業務フロー、確認基準に合わせて最適化されます。",
    ...
    "Starter, SIMY Quality, Pro, and Enterprise pricing and features": "Starter、SIMY Quality、Pro、Enterpriseの料金と機能比較",
