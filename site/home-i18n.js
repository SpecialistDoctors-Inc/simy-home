(() => {
  ...
  const JA_COPY = Object.freeze({
    ...
    "Simple monthly plans": "シンプルな月額プラン",
    "Swipe to compare plans →": "横にスワイプしてプランを比較 →",
    "Start with Autorun. Add quality and live support when you need them.": "Autorunから始める。\n品質管理も、リアルタイム支援も、必要なときに。",
    "Every plan connects to Codex, runs meeting follow-up automatically, and saves reusable pipelines.": "すべてのプランでCodexと接続し、会議後の仕事を自動で進め、パイプラインを保存・再利用できます。",
    "SIMY, SIMY Quality, and SIMY Pro monthly pricing and features": "SIMY、SIMY Quality、SIMY Proの月額料金と機能比較",
    "Monthly · USD": "月額・米ドル",
    "per month": "月額",
    "Popular": "人気",
