(() => {
  ...
  const JA_COPY = Object.freeze({
    ...
    "I matched this to your investigation pipeline. Autorun is tracing the cause and preserving the review evidence now.": "この仕事に、あなたの調査パイプラインを適用しました。Autorunが原因を追い、レビューに必要な調査結果をまとめます。",
    ...
    "I matched this to your decision-brief pipeline. Autorun is applying your materiality and evidence checks now.": "この仕事に、あなたの意思決定資料パイプラインを適用しました。Autorunが重要性と内容の確認を進めます。",
